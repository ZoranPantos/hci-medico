...
namespace HciMedico.Integration.Migrations
{
    ...
    [Migration("20240505172501_ModifySchedule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HciMedico.Domain.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HciMedico.Domain.Models.ScheduleCell", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ScheduleCell");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            DateTime = new DateTime(2024, 5, 5, 19, 24, 59, 824, DateTimeKind.Local).AddTicks(4862),
                            ScheduleId = 1,
                            ShiftEndTime = "4 PM",
                            ShiftStartTime = "8 AM"
                        },
                        ...
                        {
                            Id = 2,
                            DateTime = new DateTime(2024, 5, 6, 19, 24, 59, 824, DateTimeKind.Local).AddTicks(4945),
                            ScheduleId = 1,
                            ShiftEndTime = "4 PM",
                            ShiftStartTime = "8 AM"
                        },
                        ...
                        {
                            Id = 3,
                            DateTime = new DateTime(2024, 5, 7, 19, 24, 59, 824, DateTimeKind.Local).AddTicks(4953),
                            ScheduleId = 1,
                            ShiftEndTime = "4 PM",
                            ShiftStartTime = "8 AM"
                        });
                    ...
                    b.OwnsOne("HciMedico.Domain.Models.ContactInfo", "ContactInfo", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ...
                                    TelephoneNumber = "+39198923035"
                                },
                                new
                                {
                                    PatientId = 2,
                                    Email = "saska.macetic@test.com",
                                    TelephoneNumber = "+14513963028"
                                },
                                new
                                {
                                    PatientId = 3,
                                    Email = "milos.milosevic@test.com",
                                    TelephoneNumber = "+32671911461"
                                },
                                new
                                {
                                    PatientId = 4,
                                    Email = "ana.stanojevic@test.com",
                                    TelephoneNumber = "+94152606659"
                                },
                                new
                                {
                                    PatientId = 5,
                                    Email = "darko.darkovic@test.com",
                                    TelephoneNumber = "+26075943503"
                                },
                                new
                                {
                                    PatientId = 6,
                                    Email = "jovana.jovanovic@test.com",
                                    TelephoneNumber = "+22578262881"
                                },
                                new
                                {
                                    PatientId = 7,
                                    Email = "nikola.nikolic@test.com",
                                    TelephoneNumber = "+18146466221"
                                },
                                new
                                {
                                    PatientId = 8,
                                    Email = "david.davidovic@test.com",
                                    TelephoneNumber = "+76614776205"
                                },
                                new
                                {
                                    PatientId = 9,
                                    Email = "stana.stanojevic@test.com",
                                    TelephoneNumber = "+83083088753"
                                },
                                new
                                {
                                    PatientId = 10,
                                    Email = "goran.predojevic@test.com",
                                    TelephoneNumber = "+47968945176"
                                });
                        });
            ...
            modelBuilder.Entity("HciMedico.Domain.Models.Schedule", b =>
                {
                    b.HasOne("HciMedico.Domain.Models.Employee", "Employee")
                        .WithOne("Schedule")
                        .HasForeignKey("HciMedico.Domain.Models.Schedule", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HciMedico.Domain.Models.ScheduleCell", b =>
                {
                    b.HasOne("HciMedico.Domain.Models.Schedule", "Schedule")
