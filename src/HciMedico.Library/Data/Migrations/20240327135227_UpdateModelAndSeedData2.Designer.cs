...
namespace HciMedico.Library.Migrations
{
    ...
    [Migration("20240327135227_UpdateModelAndSeedData2")]
    partial class UpdateModelAndSeedData2
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("HciMedico.Library.Models.ContactInfo", "ContactInfo", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ...
                                    TelephoneNumber = "+64854491607"
                                },
                                new
                                {
                                    PatientId = 2,
                                    Email = "saska.macetic@test.com",
                                    TelephoneNumber = "+14894797386"
                                },
                                new
                                {
                                    PatientId = 3,
                                    Email = "milos.milosevic@test.com",
                                    TelephoneNumber = "+18864295172"
                                },
                                new
                                {
                                    PatientId = 4,
                                    Email = "ana.stanojevic@test.com",
                                    TelephoneNumber = "+53436046342"
                                },
                                new
                                {
                                    PatientId = 5,
                                    Email = "darko.darkovic@test.com",
                                    TelephoneNumber = "+26270083046"
                                },
                                new
                                {
                                    PatientId = 6,
                                    Email = "jovana.jovanovic@test.com",
                                    TelephoneNumber = "+65982361201"
                                },
                                new
                                {
                                    PatientId = 7,
                                    Email = "nikola.nikolic@test.com",
                                    TelephoneNumber = "+21591326281"
                                },
                                new
                                {
                                    PatientId = 8,
                                    Email = "david.davidovic@test.com",
                                    TelephoneNumber = "+42779034763"
                                },
                                new
                                {
                                    PatientId = 9,
                                    Email = "stana.stanojevic@test.com",
                                    TelephoneNumber = "+99489337210"
                                },
                                new
                                {
                                    PatientId = 10,
                                    Email = "goran.predojevic@test.com",
                                    TelephoneNumber = "+48876705996"
                                });
                        });
