...
namespace HciMedico.Library.Migrations
{
    ...
    [Migration("20240316225027_SchemaSetAndDataSeed8")]
    partial class SchemaSetAndDataSeed8
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("HciMedico.Library.Models.ContactInfo", "ContactInfo", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    ...
                                    TelephoneNumber = "+32521743994"
                                },
                                new
                                {
                                    PatientId = 2,
                                    Email = "saska.macetic@test.com",
                                    TelephoneNumber = "+81040222562"
                                },
                                new
                                {
                                    PatientId = 3,
                                    Email = "milos.milosevic@test.com",
                                    TelephoneNumber = "+65198148983"
                                },
                                new
                                {
                                    PatientId = 4,
                                    Email = "ana.stanojevic@test.com",
                                    TelephoneNumber = "+30152344928"
                                },
                                new
                                {
                                    PatientId = 5,
                                    Email = "darko.darkovic@test.com",
                                    TelephoneNumber = "+50667888715"
                                },
                                new
                                {
                                    PatientId = 6,
                                    Email = "jovana.jovanovic@test.com",
                                    TelephoneNumber = "+60649950726"
                                },
                                new
                                {
                                    PatientId = 7,
                                    Email = "nikola.nikolic@test.com",
                                    TelephoneNumber = "+22518257876"
                                },
                                new
                                {
                                    PatientId = 8,
                                    Email = "david.davidovic@test.com",
                                    TelephoneNumber = "+40772292032"
                                },
                                new
                                {
                                    PatientId = 9,
                                    Email = "stana.stanojevic@test.com",
                                    TelephoneNumber = "+49023783579"
                                },
                                new
                                {
                                    PatientId = 10,
                                    Email = "goran.predojevic@test.com",
                                    TelephoneNumber = "+75963599244"
                                });
                        });
